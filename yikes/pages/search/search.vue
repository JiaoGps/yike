	...
	<view class="content">
		<view class="top-bar">
			<view class="search-div">
				<image src="../../static/images/search/search.png" class="search-img" mode=""></image>
				<input type="text" class="search" 
				placeholder-style="color:#aaa;font-weight:400" 
				placeholder="搜索用户/群" @input="search" />
			</view>
		...
		<view class="main">
			<view class="search-user result">
				...
				<!-- <view class="list user">
					<image src="../../static/images/img/fulibl2.png" ></image>
					<view class="names">
						<view class="name">小菜鸡</view>
						<view class="email">disabled@qq.com</view>
					</view>
